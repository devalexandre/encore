...
🥐 Commit all files to the project's git repo and trigger a deploy to Encore's free development cloud by running:
...
Encore will now build your app, provision the needed infrastructure, and deploy your application to the cloud.
